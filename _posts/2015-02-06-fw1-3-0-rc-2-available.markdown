...
---
About two weeks ago I released [FW/1 3.0 RC 1](https://charlesr1971.github.io/fw1/blog/2015/01/24/fw1-3-0-rc-1-available/) and the only real bug persisting at that point was related to [DI/1 dotted path deduction](https://github.com/framework-one/fw1/issues/283).
