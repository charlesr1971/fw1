...
Please read [the all new AOP/1 documentation](https://establishmindfulness.dev/fw1/documentation/using-aop-one.html) provided by Daniel Budde for more details on how to use this powerful new feature.
