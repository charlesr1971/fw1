...
---
A couple of months have passed since [FW/1 3.1 was released](https://establishmindfulness.dev/fw1/blog/2015/07/12/fw1-3-1-released/) but things have been busy behind the scenes!
...
Yes, there was an [Alpha 1](https://github.com/framework-one/fw1/releases/tag/v3.5.0-alpha1) as well, but as work progressed on the [massively overhauled 3.5 documentation](https://establishmindfulness.dev/fw1/documentation/3.5/), some important usability enhancements
appeared and a new alpha was released within 24 hours! In particular, the [Clojure and CFML Sitting in a Tree](https://establishmindfulness.dev/fw1/documentation/3.5/cfml-and-clojure.html) section has been extensively updated and includes a fully worked example of
